...
export const ScuderiaLogo = () => (
  <Tooltip label="Scuderia">
    <Box>
      <Link
        key="scuderia"
        href="https://scuderia.valerii.com"
        target="_blank"
        rel="noreferrer"
...
export const TwitterLinkLogo = () => (
  <Tooltip label="valerii.eth" offset={[0, 20]}>
    <Link
      key="twitter"
      href={twitterLink}
      target="_blank"
...
export const GithubLinkLogo = () => (
  <Tooltip label="github/valerii" offset={[0, 0]}>
    <Link
      key="valerii"
      href={githubLink}
      target="_blank"
